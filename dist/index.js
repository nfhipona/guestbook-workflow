...
var require_constants = __commonJS({
  "src/components/constants.js"(exports, module2) {
    ...
    var COMMITTER_MESSAGE = core.getInput("commit_message");
  ...
  "src/components/issue.js"(exports, module2) {
    var Issue = class {
      ...
      toEntryString(identifier, delimiter, template, max_character_count = 0) {
        ...
        return template.replace("$username", this.author).replace("$profile", this.profile).replace("$date", this.createdAt).replace("$title", this.getTitle(identifier, delimiter)).replace("$content", contents);
      }
      avatarString() {
